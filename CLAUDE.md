# tabinal — TUI Terminal Multiplexer

## Overview
Rust TUI tool for managing multiple terminal sessions in split panes with tabs and a file tree sidebar.
...
- `TABINAL=1` is set in every spawned pane to detect nested instances
